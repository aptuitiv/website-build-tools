...
export default {
    javascript: {
        files: ['filename.js', 'subFolder/my-file.js'],
    },
};
```
...
- [CommonJS (cjs)](/configuration/examples/cjs)
- [ES Module (js)](/configuration/examples/js)
...
| css                       |                                                      | The [CSS configuration](/configuration/css).                                                                                                        |
...
| copy                      | []                                                   | An array of file globs to copy and their destination folders. See [copy files action](/command-line/copy-files).                                    |
| eslint                    | {}                                                   | [Eslint configuration](/configuration/javascript#linting-javascript).                                                                               |
...
| ftp.sound                 | 'Bottle'                                             | The sound to use for the notification. This is only used on macOS. See sound names in /System/Library/Sounds. You can also use 'default'.           |
| icons                     | `[{build: 'snippets/svg-icons.twig', src: 'icons'}]` | [Icon file configuration](/configuration/icons).                                                                                                    |
| images                    |                                                      | [Image file configuration](/configuration/images).                                                                                                  |
| images.build              | 'images'                                             | The folder for the images within the theme build folder. (config.build.theme)                                                                       |
| images.optimizations      |                                                      | [Image optimization configuration](/configuration/images#image-optimizations).                                                                      |
| images.optimizations.jpg  |                                                      | [JPG image optimization configuration](/configuration/images#jpg-optimizations)                                                                     |
| images.optimizations.png  |                                                      | [PNG image optimization configuration](/configuration/images#png-optimizations)                                                                     |
| images.optimizations.webp |                                                      | [WebP image optimization configuration](/configuration/images#webp-optimizations)                                                                   |
| images.src                | 'images'                                             | The source folder for the image files within the root source folder. (config.src)                                                                   |
| javascript                |                                                      | [Javascript configuration](/configuration/javascript).                                                                                              |
...
| stylelint                 | {}                                                   | [Stylelint configuration options](/configuration/css#linting-css-files).                                                                            |
